...
def announce_lead_changes(score0, score1, last_leader=None):
    ...
    if new_leader != last_leader and score0 != score1:
        msg = 'Player {} takes the lead by {}'.format(new_leader, abs(score0 - score1))
    
    return new_leader, msg
    # END PROBLEM 6
...
def hog_pile_strategy(score, opponent_score, threshold=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    if 0 < hog_pile(score + hefty_hogs(score, opponent_score), opponent_score):
        return 0
    else:
